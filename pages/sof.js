...
export default function lang() {
  ...
  const string = '<Glow-DEV-Search>'
  function handleSubmit(e) {
    e.preventDefault()
    const url = `https://stackoverflow.com/search?q=${inputRef.current.value}`
    console.log(url);
  ...
  return (
    ...
    <div className='body'> 
      <Head>
        <meta property="og:title" content="<Glow-DEV-Search>" />
        ...
        <meta property="og:description" content="A custom search homepage for devlopers made using stackoverflow" />
      </Head>
      ...
      <style jsx>{`
        ...
        .wrapper {
            ...
            height: 100%;
            position: absolute;
            background: linear-gradient(45deg,#00db3e, #00b3db);
